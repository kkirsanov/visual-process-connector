...
/*
1. Берешь выходной пин WDM Capture Device.
2. Получаешь с него IAMStreamConfig.
3. Перечисляешь форматы, доступные на выходном пине с помощью IPin::EnumMediaTypes.
4. Выбираешь формат с нужным тебе разрешением и задаешь его с помощью IAMStreamConfig::SetFormat.
*/
	...
	AM_MEDIA_TYPE *pMT)
{
	...
	hr = ConnectFilters(pGraph, pOut, pDest, pMT);
	pOut->Release();
	return hr;
}
