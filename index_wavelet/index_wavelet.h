// index_wavelet.h : main header file for the index_wavelet DLL
//
...
// Cindex_waveletApp
// See index_wavelet.cpp for the implementation of this class
//

class Cindex_waveletApp : public CWinApp
{
public:
	Cindex_waveletApp();
...
class WaveltExtractor: public Plugin {
	friend class SimpleOutImagePin<WaveltExtractor>;
private:
	PBitmap tempBMP;
	PImage  image;

public:
	WaveltExtractor(Core *pCore);
	virtual ~WaveltExtractor();
...
public:
	Wavelet(CxImage *bmp);
	boost::shared_ptr<Wavelet2D> waveletH;
	boost::shared_ptr<Wavelet2D> waveletV;
};
