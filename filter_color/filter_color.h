// filter_color.h : main header file for the filter_color DLL
//
...
// Cfilter_colorApp
// See filter_color.cpp for the implementation of this class
//

class Cfilter_colorApp : public CWinApp
{
public:
	Cfilter_colorApp();
